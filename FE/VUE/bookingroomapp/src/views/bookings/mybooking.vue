<template>
   <nav class="navbar navbar-expand-lg navbar-light bg-light">
    <a class="navbar-brand mx-5" href="http://localhost:5173/bookings">BookingApp</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link" href="http://localhost:5173/bookings">Room Booking</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" href="http://localhost:5173/mybooking">My Bookings</a>
        </li>
        <li v-if="role == 1 || role == 2" class="nav-item">
          <a class="nav-link" href="http://localhost:5173/room">Room Management</a>
        </li>
        <li v-if="role == 2" class="nav-item">
          <a class="nav-link" href="http://localhost:5173/edit">User Management</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="http://localhost:5173/logout">Logout</a>
        </li>
        <!-- <li class="nav-item">
...
<div class="container my-5">
  ...
  <div class="container">
    ...
    <a class="btn btn-primary" style="text-align: center;" data-toggle="collapse" href="http://localhost:5173/bookings" role="button" aria-expanded="false" aria-controls="collapseExample">
    Order Booking
  </a>
  </div>
    </div>
