<template>
    ...
    <a class="navbar-brand mx-5" href="http://localhost:5173/login">BookingApp</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link active" href="http://localhost:5173/login">Login</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="http://localhost:5173/register">Register</a>
        </li>
        <!-- <li class="nav-item">
